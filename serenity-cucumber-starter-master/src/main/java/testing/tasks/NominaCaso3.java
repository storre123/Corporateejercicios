...
public class NominaCaso3 implements Task {

    private final String rutaArchivo;

    public NominaCaso3(String rutaArchivo) {
    ...
    public static NominaCaso3 conRuta(String rutaArchivo) {
        return new NominaCaso3(rutaArchivo);
    }
}
