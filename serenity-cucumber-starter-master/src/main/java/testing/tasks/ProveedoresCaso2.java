...
public class ProveedoresCaso2 implements Task {
    private final String rutaArchivo;

    public ProveedoresCaso2(String rutaArchivo) {
    ...
    public static ProveedoresCaso2 conRuta(String rutaArchivo) {
        return new ProveedoresCaso2(rutaArchivo);
    }
}
