...
public class NominaCaso1 implements Task {

    private final String rutaArchivo;

    public NominaCaso1(String rutaArchivo) {
    ...
    public static NominaCaso1 conRuta(String rutaArchivo) {
        return new NominaCaso1(rutaArchivo);
    }
