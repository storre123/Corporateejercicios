...
public class ProveedoresCaso1 implements Task {
    private final String rutaArchivo;

    public ProveedoresCaso1(String rutaArchivo) {
    ...
    public static ProveedoresCaso1 conRuta(String rutaArchivo) {
        return new ProveedoresCaso1(rutaArchivo);
    }
}
