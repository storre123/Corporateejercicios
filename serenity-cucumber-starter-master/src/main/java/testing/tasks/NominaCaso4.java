...
public class NominaCaso4 implements Task {

    private final String rutaArchivo;

    public NominaCaso4(String rutaArchivo) {
    ...
    public static NominaCaso4 conRuta(String rutaArchivo) {
        return new NominaCaso4(rutaArchivo);
    }
}
