...
public class ProveedoresCaso4 implements Task {
    private final String rutaArchivo;

    public ProveedoresCaso4(String rutaArchivo) {
    ...
    public static ProveedoresCaso4 conRuta(String rutaArchivo) {
        return new ProveedoresCaso4(rutaArchivo);
    }
}
